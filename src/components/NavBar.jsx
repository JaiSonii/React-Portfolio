          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href={linkedIn} target="blank"><img src={navIcon1} alt="" /></a>
                <a href={gitHub} target="blank"><img src={gitHubIcon} alt="" /></a>
                <a href={instaLink} target="blank"><img src={navIcon3} alt="" /></a>
              </div>
              <HashLink to='#connect'>
